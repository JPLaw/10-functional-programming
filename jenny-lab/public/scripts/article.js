...
function Article(rawDataObj) {
  ...
  //One of the primary purposes of lexical arrow functions, besides cleaning up syntax to use fewer lines of code, 
  //is to also preserve context. 
  //That means that when you declare a function using lexical arrows, "this" inside the function will still be the same "this" 
  //as it was outside the function. 
